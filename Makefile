# This Makefile is for the Apache2::UcomOneTimeUrl extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Apache2/UcomOneTimeUrl.pm]
#     AUTHOR => q[A. U. Thor <ucomadmin@localdomain>]
#     BUILD_REQUIRES => {  }
#     NAME => q[Apache2::UcomOneTimeUrl]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Apache2/UcomOneTimeUrl.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Apache2::UcomOneTimeUrl
NAME_SYM = Apache2_UcomOneTimeUrl
VERSION = undef
...
MAKE = make
FULLEXT = Apache2/UcomOneTimeUrl
BASEEXT = UcomOneTimeUrl
PARENT_NAME = Apache2
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Apache2/UcomOneTimeUrl.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Apache2/UcomOneTimeUrl.pm
...
TO_INST_PM = authorize.pl \
	lib/Apache2/UcomOneTimeUrl.pm \
	read-mldbm.pl

PM_TO_BLIB = read-mldbm.pl \
	$(INST_LIB)/Apache2/read-mldbm.pl \
	authorize.pl \
	$(INST_LIB)/Apache2/authorize.pl \
	lib/Apache2/UcomOneTimeUrl.pm \
	blib/lib/Apache2/UcomOneTimeUrl.pm
...
DISTNAME = Apache2-UcomOneTimeUrl
DISTVNAME = Apache2-UcomOneTimeUrl-undef
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Apache2/UcomOneTimeUrl.pm $(INST_MAN3DIR)/Apache2::UcomOneTimeUrl.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Apache2-UcomOneTimeUrl' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            undef' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           One-Time use URLs(URIs) for senstive data' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - A. U. Thor <ucomadmin@localdomain>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>One-Time use URLs(URIs) for senstive data</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>A. U. Thor &lt;ucomadmin@localdomain&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  read-mldbm.pl $(INST_LIB)/Apache2/read-mldbm.pl \
	  authorize.pl $(INST_LIB)/Apache2/authorize.pl \
	  lib/Apache2/UcomOneTimeUrl.pm blib/lib/Apache2/UcomOneTimeUrl.pm 
